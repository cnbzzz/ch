package com.github.cnbzzz.core.aop;
...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    @ResponseBody
    public ErrorResponseData duplicateKey(RuntimeException e) {
        LogManager.me().executeLog(LogTaskFactory.exceptionLog(ShiroKit.getUser().getId(), e));
        getRequest().setAttribute("tip", "数据重复");
        log.error("运行时异常:", e);
        return new ErrorResponseData(BizExceptionEnum.DUPLICATE_KEY.getCode(), BizExceptionEnum.DUPLICATE_KEY.getMessage());
    }
