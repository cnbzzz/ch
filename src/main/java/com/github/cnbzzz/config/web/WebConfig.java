...
import com.github.cnbzzz.core.common.controller.ChErrorView;
import com.github.cnbzzz.core.interceptor.RestApiInteceptor;
import com.github.cnbzzz.core.listener.ConfigListener;
...
public class WebConfig implements WebMvcConfigurer {
     ...
     */
    @Bean("error")
    public ChErrorView error() {
        return new ChErrorView();
    }
    ...
    public JdkRegexpMethodPointcut druidStatPointcut() {
        ...
        String patterns = "com.github.cnbzzz.modular.*.service.*";
        //可以set多个
