 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "ch.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2, proxyTargetClass = true)
@MapperScan(basePackages = {"com.github.cnbzzz.modular.*.dao", "com.github.cnbzzz.multi.mapper"})
public class MultiDataSourceConfig {
     ...
     */
    @Bean
    @ConfigurationProperties(prefix = "ch.muti-datasource")
